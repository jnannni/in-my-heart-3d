  ...
  return (
    <>
        ...
        skillLevel={skills[1].level}>
            <CustomShapewTex meshRot={[0, 0.3, -0.2]} materialColor='#F0DB4F' materialTexture={jsTexture} boxArgs={[0.7, 0.7, 0.1]}/>           
        </Skill>
        <Skill
        ...
        skillLevel={skills[2].level}>
            <CustomShapewTex meshRot={[0.5, 0.3, 0]} materialColor='#36454F' materialTexture={htmlTexture} boxArgs={[0.7, 0.7, 0.1]} />
        </Skill>
        <Skill
        ...
        skillLevel={skills[3].level}>
            <CustomShapewTex meshRot={[0.5, 0.3, 0]} materialColor='#36454F' materialTexture={cssTexture} boxArgs={[0.7, 0.7, 0.1]} />
        </Skill>
        <Skill
        ...
        skillLevel={skills[4].level}>
            <CustomShapewTex meshRot={[0.5, 0.3, 0]} materialColor='#36454F' materialTexture={threeTexture} boxArgs={[0.7, 0.7, 0.1]} />
        </Skill>
